module "instant-delivery-service_development" { # use "_" as seperator
  ...
  name                    = "instant-delivery-service"
  container_image         = "088074866799.dkr.ecr.ap-southeast-1.amazonaws.com/instant-delivery-service:latest"
  port                    = 14022
  domain                  = "dev-instant-delivery-service.test.com"
  health_check_path       = "/health-check"
}

module "instant_delivery_service_production" {
  ...
  container_image         = "088074866799.dkr.ecr.ap-southeast-1.amazonaws.com/instant-delivery-service:latest"
  port                    = 14022
  domain                  = "instant-delivery-service.test.com"
  health_check_path       = "/health-check"
}

output "instant_delivery_service_production_alb_endpoint_production" {
  description = "ALB Endpoint"
  value       = var.env == "Production" ? module.instant_delivery_service_production[0].alb_endpoint : null
}